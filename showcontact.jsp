    ...
    <body>
        ...
        <div class="content">
            ...
            <div class="container-fluid"> 
                ...
                <%
                    String catId=request.getParameter("Contactdeletebyid");
                    
                    
                    ContactDao cdao=new ContactDao(ConnectionProvider.getConnection());
                    
                    if(catId==null || catId.trim().equals("Contactdeletebyid")){
                ...
                <sql:query dataSource="${db}" var="rs">select*from contact;</sql:query>
                    <br>
                    <br>
                    <br>
                    ...
                    <table class="table table-striped">
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th scope="col">Contact<span style="color: #19B3D3"> ID</span></th>
                                <th scope="col">Contact<span style="color: #19B3D3"> Name</span></th>
                                <th scope="col">Contact<span style="color: #19B3D3"> Surname</span></th>
                                <th scope="col">Contact<span style="color: #19B3D3"> Email</span></th>
                                <th scope="col">Contact<span style="color: #19B3D3"> Number</span></th>
                                <th scope="col">Contact<span style="color: #19B3D3"> Message</span></th>
                                <th scope="col">Contact<span style="color: #19B3D3"> #</span></th>
                        ...
                        <c:forEach var="tb"  items="${rs.rows}">
                            ...
                            <tr>
                                <th scope="row">#<c:out value="${tb.id}"></c:out></th>
                                <td><c:out value="${tb.name}"></c:out></td>
                                <td><c:out value="${tb.surname}"></c:out></td>
                                <td><c:out value="${tb.email}"></c:out></td>
                                <td><c:out value="${tb.number}"></c:out></td>
                                <td><c:out value="${tb.message}"></c:out></td>
                                <td><a href="showcontact.jsp?Contactdeletebyid=<c:out value="${tb.id}"></c:out>" class="btn btn-outline-danger">Delete</a></td>
                    ...
                    <%
                        ...
                        boolean f=cdao.getContactIdDeleteByAdmin(cid);
                        if(f){
                            HttpSession s=request.getSession();
                            session.setAttribute("message", "Contact Successfully Deleted");
