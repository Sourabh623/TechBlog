    ...
    <body>
        ...
        <header>
            ...
            <div class="right_area">
                <a href="admin_login.jsp" class="logout_btn">Logout</a>
            </div>
        </header>
        <!--header area end-->
        <!--sidebar start-->
        ...
        <div class="content">
            ...
            <div class="container-fluid"> 
                ...
                <%
                    ...
                    AdminDao admin1=new AdminDao(ConnectionProvider.getConnection());
                ...
                <sql:query dataSource="${db}" var="rs">select*from admin;</sql:query>
                    <br>
                    <br>
                    <br>
                    ...
                    <table class="table table-striped">
                        <thead class="thead-dark">
                            <tr>
                                ...
                                <th scope="col">Admin<span style="color: #19B3D3"> Name</span></th>
                                <th scope="col">Admin<span style="color: #19B3D3"> Password</span></th>
                                <th scope="col">Admin<span style="color: #19B3D3"> Register Date&Time</span></th>
                                <th scope="col">Admin<span style="color: #19B3D3"> #</span></th>
                        ...
                        <c:forEach var="tb"  items="${rs.rows}">
                            ...
                            <tr>
                                <th scope="row">#<c:out value="${tb.username}"></c:out></th>
                                <td><c:out value="${tb.password}"></c:out></td>
                                <td><c:out value="${tb.rdate}"></c:out></td>
                                <td><a href="view_administers?username=<c:out value="${tb.username}"></c:out>" class="btn btn-outline-danger">Delete</a></td>
                    ...
                    <%
                        ...
                        String useradmin=(username.trim());
                        boolean f=admin1.getAdminUsernameDeleteByAdmin(useradmin);
                        if(f){
                            HttpSession s=request.getSession();
                            session.setAttribute("message", "Admin Successfully Deleted");
                            response.sendRedirect("view_administers.jsp");
                        }else{
